    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-3xl font-bold text-gray-800">Smart ERP</h2>
          <p class="text-gray-500 mt-2">Silakan login untuk melanjutkan</p>
        </div>

        <!-- Alert Error -->
        <div v-if="errorMessage" class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start">
        ...
        <form @submit.prevent="handleLogin">
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            <a href="#" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">Lupa password?</a>
          </div>
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition duration-200 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
