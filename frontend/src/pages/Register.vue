    ...
    <div class="max-w-md w-full">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-500 mt-2">Daftar untuk menggunakan SmartERP</p>
        </div>
        ...
        <div v-if="errorMessage" class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start">
          ...
          <div>
            ...
            <ul v-if="errors" class="mt-2 text-xs text-red-700 list-disc list-inside">
        ...
        <!-- Alert Success -->
        <div v-if="successMessage" class="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start">
